...
# PathDB not initialized.  Create default MySQL database and make PathDB changes
	...
	curl --user admin:bluecheese2018 -k -X POST http://localhost/entity/menu_link_content?_format=json -H "Content-Type: application/json" -d '{"bundle": [{"value": "menu_link_content"}],"enabled": [{"value": true}],"title": [{"value": "Review"}],"description": [],"menu_name": [{"value": "main"}],"link": [{"uri": "internal:/review","title": "","options": []}],"weight": [{"value": 4}],"expanded": [{"value": true}]}'
